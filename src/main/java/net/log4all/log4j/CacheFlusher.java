...
public class CacheFlusher implements Runnable {
	...
	public CacheFlusher(String log4allUrl, String application, String token, String basicCacheFile) {
	...
	public void run() {
		...
		Log4AllClient log4allClient = new Log4AllClient(log4allUrl, this.application, this.token);
		try {
